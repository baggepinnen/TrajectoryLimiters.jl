...
X, Ẋ, Ẍ, X⃛ = limiter(R; causal=true)


# TODO: See if set_prestabilizing_feedback! improves numerical performance
...
X2, Ẋ2, Ẍ2, X⃛2 = limiter(similar(X), similar(Ẋ), similar(Ẍ), similar(X⃛), R)
# @test X2 ≈ X rtol=1e-4
